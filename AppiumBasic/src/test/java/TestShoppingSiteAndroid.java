...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("customer-email"))).sendKeys("thang@gmail.com");
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='lastname']"))).sendKeys("nguyen");
